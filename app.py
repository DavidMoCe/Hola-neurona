...
with tab1:
    ...
    peso = st.slider("Peso", 0, 5, step=0.5, key="peso_tab1")
...
with tab2:
    w_0 = st.slider("Peso w_0", 0, 5, step=0.5, key="w0_tab2")
    x_0 = st.number_input("Entrada x_0", key="x0_tab2")
    
    w_1 = st.slider("Peso w_1", 0, 5, step=0.5, key="w1_tab2")
    ...
    if st.button("Calcular", key="boton_1"):
        st.write("La salida de la neurona es", resultado)
with tab3:
    w_0 = st.slider("Peso w_0", 0, 5, step=0.5, key="w0_tab3")
    x_0 = st.number_input("Entrada x_0", key="x0_tab3")
    
    w_1 = st.slider("Peso w_1", 0, 5, step=0.5, key="w1_tab3")
    x_1 = st.number_input("Entrada x_1", key="x1_tab3")

    w_2 = st.slider("Peso w_2", 0, 5, step=0.5, key="w2_tab3")
